...
<body>
    ...
    <div class="container mt-5">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#moneyPointsTab">Đặt vé của tôi</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#Mode">Mua Vé</a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            ...
            <div id="moneyPointsTab" class="container tab-pane fade"><br>
                <form>
                    <div class="form-group">
                        <label for="bookingOrTicketNumber">Mã Đặt Chỗ/Số Vé</label>
                        <input type="text" class="form-control" id="bookingOrTicketNumber" placeholder="123xxxxxxxxx">
                    </div>
                    <div class="form-group">
                        <label for="surname">Họ</label>
                        <input type="text" class="form-control" id="surname" placeholder="NGUYEN">
                    </div>
            ...
            <div id="Mode" class="container tab-pane fade"><br>
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="bookingOrTicketNumber">Mã Chuyến Bay</label>
                        <input type="text" class="form-control" id="IdFlgiht" name="IdFlgiht" placeholder="123xxxxxxxxx">
                        <span style="color: red;"><?= $thongBaoLoi ?></span>

                    </div>
                    <div class="form-group">
                        <label for="bookingOrTicketNumber">Điểm Đầu</label>
                        <input type="text" class="form-control" id="=from" name="from" placeholder="123xxxxxxxxx">
                        <span style="color: red;"><?= $thongBaoLoi ?></span>

                    </div>
                    <div class="form-group">
                        <label for="bookingOrTicketNumber">Điểm Cuối</label>
                        <input type="text" class="form-control" id="to" name="to" placeholder="123xxxxxxxxx">
                        <span style="color: red;"><?= $thongBaoLoi ?></span>

                    </div>
                    <div class="form-group">
                        <label for="bookingOrTicketNumber">Thời gian</label>
                        <input type="date" class="form-control" id="date" name="date" placeholder="123xxxxxxxxx">
                        <span style="color: red;"><?= $thongBaoLoi ?></span>

                    </div>
                    <div class="form-group">
                        <label for="bookingOrTicketNumber">Mã Khách Hàng</label>
                        <input type="text" class="form-control" id="MKH" name="MKH" placeholder="123xxxxxxxxx">
                        <span style="color: red;"><?= $thongBaoLoi ?></span>

                    </div>
                    <div class="form-group">
                        <label for="bookingOrTicketNumber">Tên Khách Hàng</label>
                        <input type="text" class="form-control" id="NameKH" name="NameKH" placeholder="123xxxxxxxxx">
                        <span style="color: red;"><?= $thongBaoLoi ?></span>

                    </div>
                    <div class="form-group">
                        <label for="bookingOrTicketNumber">Ghi Chú</label>
                        <input type="text" class="form-control" id="Note" name="Note" placeholder="123xxxxxxxxx">
                        <span style="color: red;"><?= $thongBaoLoi ?></span>

                    </div>
                    <div class="form-group">
                        <label for="bookingOrTicketNumber">Trọng Lượng</label>
                        <input type="text" class="form-control" id="nang" name="nang" placeholder="123xxxxxxxxx">
                        <span style="color: red;"><?= $thongBaoLoi ?></span>

                    </div>
                    <div class="form-group">
                        <label for="bookingOrTicketNumber">Mã Giảm Giá Nếu có</label>
                        <input type="text" class="form-control" id="voucher" name="voucher" placeholder="123xxxxxxxxx" disabled>
                        <span style="color: red;"><?= $thongBaoLoi ?></span>

                    </div>
                    <div class="form-group">
                        <label for="bookingOrTicketNumber">Thành Tiền</label>
                        <input type="text" class="form-control" id="money" name="money" placeholder="123xxxxxxxxx" disabled>
                    </div>
                    <button type="submit" class="btn btn-primary" name="BuyVe">Tìm Kiếm</button>
                </form>
            </div>
        </div>
    </div>
