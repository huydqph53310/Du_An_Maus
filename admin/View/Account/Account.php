...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="?act=user">Thông tin Tài Khoản</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    if (isset($_SESSION["Email"])) { ?>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="?act=user"><?= $ngonNgu  == 1 ? "Thôn Tin \nTài Khoản" : "Info Account " ?></a>
                            <a class="dropdown-item" href="<?= $url?>/?act=logout"><?= $ngonNgu  == 1 ? "Đăng Xuất" : "Logout" ?></a>
                            <?php if ($vaiTro == 1) { ?>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="?act=admin"><?= $vaiTro == 1 ? "Trang quản trị" : "Tab Manganer" ?></a>
                            <?php } ?>
                        </div>
                    <?php } else { ?>
                        <div class="dropdown-menu">
    ...
    <div class="container profile-container">
        <div class="row">
            <div class="col-md-3 profile-sidebar">
                ...
                <div class="sidebar-item">
                    <a href="?act=logout"><?= $ngonNgu == 1 ? "Đăng Xuất" : "Logout" ?></a>
                </div>
            </div>
            <div class="col-md-9">
